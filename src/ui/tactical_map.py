...
def _stable_layer_id(args, kwargs):
    ...
    discriminator = repr((layer_type, get_position, get_source_position,
                          get_target_position, get_fill_color, get_line_color,
                          get_radius, get_width, get_path, get_polygon,
                          kwargs.get("pickable")))
